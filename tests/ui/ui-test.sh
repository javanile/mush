...
test_tures_ui_command_publish_publish() { assert_equals "$(cat tests/fixtures/ui/command/publish/publish.out)" "$(cat tests/fixtures/ui/command/publish/publish.out.0)"; }
